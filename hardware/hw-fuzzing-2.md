...
当我们测试了一个测试点之后，不仅仅学到了这个测试点的信息，还学到了相关点的信息，这里我们可以简单考虑边的权重，比如两个点之间的关系是0.9，那么一个点的 100% 信息被学习之后，另一个点的 90% 的信息也被学习了，所以这个点就只剩下了 10% 的可学习信息，信息量大大下降。这就解释了为什么对于同类型的点，当我们学习了一部分之后，其余部分的学习价值会大大下降。
